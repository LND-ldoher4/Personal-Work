...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self,  *args, **kwargs):
        ...
        uic.loadUi('C:/Users/Liam Doherty/Documents/Pressure sensor code-20220927T200635Z-001/Pressure sensor code/Pressure_Graphing.ui', self)
        ...
        self.gScat = self.ScatterWidget.scatterPlot(self.x,self.sy, pen=pen_g, symbol= 'o', symbolSize = 6,symbolBrush='green')
        self.rScat = self.ScatterWidget.scatterPlot(self.x,self.sz, pen=pen_r, symbol= 'o', symbolSize = 6,symbolBrush='red')
        self.outScat = self.ScatterWidget.scatterPlot(self.out,self.sz, pen=pen_out, symbol= 's', symbolSize=8, symbolBrush='grey')
        self.GLineWidget.setYRange(0,1200)
        #self.ScatterWidget.setYRange(0,58)
        ...
        self.ScatterWidget.setLabel('left', "<span style=\"color:black;font-size:15px\">Pressure (Newton)</span>")
        self.ScatterWidget.setLabel('bottom', "<span style=\"color:black;font-size:15px\"> Count</span>")
        #---------------------------------------------------------------------------------------------------#
